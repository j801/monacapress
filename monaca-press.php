...
Description: The MonacaPress Plugin is generator for smart devices application. This Plugin connect monaca.mobi and extract any files. monaca can make mobile application by HTML5. 
Version: 0.1
...
function monaca_press_activate() 
{
  ...
  $projects['monaca_press'] = array(
    'path' => __file__,
    'info' => 'MonacaPress通信テストアプリ',
  );
